...
export default function search({ searchResults }) {
	...
	let startDate2 = new Date(startDate).toString().split('2022')[0]
	const endDate2 = new Date(endDate).toString().split('2022')[0]
		...
		<div className="" >
			...
			<main className="flex" >
				<section className="flex-grow pt-14 px-6" >
					<p className="text-xs">100+ Stays - {range} - for {noOfGuests} Number of Guests</p>
